...
PhasequeWidget::PhasequeWidget(Phaseque *module)
{
    ...
    addParam(createParam<ZZC_VBPSVOCTSwitch>(Vec(49.f, 37.f),
                                             module,
                                             Phaseque::USE_COMPATIBLE_BPM_CV_PARAM));
    ...
    addParam(createParam<ZZC_LEDBezelDark>(Vec(15.3f, 82.3f),
                                           module,
                                           Phaseque::TEMPO_TRACK_SWITCH_PARAM));
    addChild(createLight<LedLight<ZZC_YellowLight>>(Vec(17.1f, 84.0f),
                                                    module,
                                                    Phaseque::TEMPO_TRACK_LED));
    ...
    addParam(
        createParam<ZZC_LEDBezelDark>(Vec(120.3f, 51.3f), module, Phaseque::ABS_MODE_SWITCH_PARAM));
    addChild(
        createLight<LedLight<ZZC_YellowLight>>(Vec(122.1f, 53.0f), module, Phaseque::ABS_MODE_LED));
    ...
    addParam(
        createParam<ZZC_LEDBezelDark>(Vec(190.3f, 51.3f), module, Phaseque::CLUTCH_SWITCH_PARAM));
    addChild(
        createLight<LedLight<ZZC_YellowLight>>(Vec(192.1f, 53.0f), module, Phaseque::CLUTCH_LED));
    ...
    addParam(createParam<ZZC_PhasequePatternResoKnob>(Vec(154, 80.8f),
                                                      module,
                                                      Phaseque::PATTERN_RESO_PARAM));

    addInput(createInput<ZZC_PJ_Port>(Vec(224, 81), module, Phaseque::RESET_INPUT));
    addParam(
        createParam<ZZC_LEDBezelDark>(Vec(225.3f, 51.3f), module, Phaseque::RESET_SWITCH_PARAM));
    addChild(
        createLight<LedLight<ZZC_YellowLight>>(Vec(227.1f, 53.0f), module, Phaseque::RESET_LED));
    ...
    addParam(
        createParam<ZZC_LEDBezelDark>(Vec(295.3f, 221.3f), module, Phaseque::WAIT_SWITCH_PARAM));
    ...
    addParam(createParam<ZZC_LEDBezelDark>(Vec(260.3f, 278.3f),
                                           module,
                                           Phaseque::GLOBAL_GATE_SWITCH_PARAM));
    addChild(createLight<LedLight<ZZC_YellowLight>>(Vec(262.1f, 280.0f),
                                                    module,
                                                    Phaseque::GLOBAL_GATE_LED));

    addInput(createInput<ZZC_PJ_Port>(Vec(14, 319.75f), module, Phaseque::GLOBAL_SHIFT_INPUT));
    addParam(
        createParam<ZZC_Knob25NoRand>(Vec(14.05f, 276.9f), module, Phaseque::GLOBAL_SHIFT_PARAM));

    addInput(createInput<ZZC_PJ_Port>(Vec(49, 319.75f), module, Phaseque::GLOBAL_LEN_INPUT));
    addParam(
        createParam<ZZC_Knob25NoRand>(Vec(49.05f, 276.9f), module, Phaseque::GLOBAL_LEN_PARAM));

    addInput(createInput<ZZC_PJ_Port>(Vec(294, 277), module, Phaseque::GLOBAL_EXPR_CURVE_INPUT));
    addInput(
        createInput<ZZC_PJ_Port>(Vec(294, 319.75f), module, Phaseque::GLOBAL_EXPR_POWER_INPUT));
    ...
    addParam(createParam<ZZC_LEDBezelDark>(Vec(120.3f, 278.3f),
                                           module,
                                           Phaseque::SHIFT_LEFT_SWITCH_PARAM));
    addChild(createLight<LedLight<ZZC_YellowLight>>(Vec(122.1f, 280.0f),
                                                    module,
                                                    Phaseque::SHIFT_LEFT_LED));

    addParam(createParam<ZZC_PhasequePatternShiftKnob>(Vec(150.5f, 273.5f),
                                                       module,
                                                       Phaseque::PATTERN_SHIFT_PARAM));

    addParam(createParam<ZZC_LEDBezelDark>(Vec(190.3f, 278.3f),
                                           module,
                                           Phaseque::SHIFT_RIGHT_SWITCH_PARAM));
    addChild(createLight<LedLight<ZZC_YellowLight>>(Vec(192.1f, 280.0f),
                                                    module,
                                                    Phaseque::SHIFT_RIGHT_LED));

    addParam(
        createParam<ZZC_LEDBezelDark>(Vec(225.3f, 278.3f), module, Phaseque::LEN_SWITCH_PARAM));
    addChild(
        createLight<LedLight<ZZC_YellowLight>>(Vec(227.1f, 280.0f), module, Phaseque::LEN_LED));
    ...
    addParam(
        createParam<ZZC_PhasequeMutaKnob>(Vec(153, 318), module, Phaseque::PATTERN_MUTA_PARAM));

    addInput(createInput<ZZC_PJ_Port>(Vec(189, 319.75f), module, Phaseque::MUTA_INC_INPUT));

    addParam(
        createParam<ZZC_LEDBezelDark>(Vec(225.3f, 320.3f), module, Phaseque::FLIP_SWITCH_PARAM));
    addChild(
        createLight<LedLight<ZZC_YellowLight>>(Vec(227.1f, 322.0f), module, Phaseque::FLIP_LED));
    ...
    for (int i = 0; i < NUM_STEPS; i++) {
        addParam(
            createParam<ZZC_PhasequeStepAttrKnob23>(Vec(stepsAreaX + stepPeriod * i - 0.5f, 48),
                                                    module,
                                                    Phaseque::STEP_VALUE_PARAM + i));
        addParam(createParam<ZZC_LEDBezelDark>(Vec(stepsAreaX + 3.3f + stepPeriod * i, 82.3f),
                                               module,
                                               Phaseque::GATE_SWITCH_PARAM + i));
        addChild(
            createLight<LedLight<ZZC_YellowLight>>(Vec(stepsAreaX + 5.1f + stepPeriod * i, 84.0f),
                                                   module,
                                                   Phaseque::GATE_SWITCH_LED + i));
        addParam(
            createParam<ZZC_PhasequeStepAttrKnob21>(Vec(stepsAreaX + 0.5f + stepPeriod * i, 110.5f),
                                                    module,
                                                    Phaseque::STEP_SHIFT_PARAM + i));
        addParam(createParam<ZZC_PhasequeStepAttrKnob21Uni>(
            Vec(stepsAreaX + 0.5f + stepPeriod * i, 141.5f),
            module,
            Phaseque::STEP_LEN_PARAM + i));
        addParam(
            createParam<ZZC_PhasequeStepAttrKnob19>(Vec(stepsAreaX + 1.5f + stepPeriod * i, 176.f),
                                                    module,
        ...
        if (module) {
            exprDisplay->paramQuantityX
                = module->paramQuantities[Phaseque::STEP_EXPR_POWER_PARAM + i];
            exprDisplay->paramQuantityY
                = module->paramQuantities[Phaseque::STEP_EXPR_CURVE_PARAM + i];
        }
        exprDisplay->setupSize();
        addParam(exprDisplay);

        addParam(
            createParam<ZZC_PhasequeStepAttrKnob19>(Vec(stepsAreaX + 1.5f + stepPeriod * i, 240.5f),
                                                    module,
                                                    Phaseque::STEP_EXPR_OUT_PARAM + i));

        addInput(createInput<ZZC_PJ_Port>(Vec(stepsAreaX + 2.0f + stepPeriod * i, 271),
                                          module,
                                          Phaseque::STEP_JUMP_INPUT + i));
        addChild(
            createLight<SmallLight<GreenLight>>(Vec(stepsAreaX + 11.3f + stepPeriod * i, 301.5f),
                                                module,
                                                Phaseque::STEP_GATE_LIGHT + i));
        addOutput(createOutput<ZZC_PJ_Port>(Vec(stepsAreaX + 2.0f + stepPeriod * i, 319.75f),
                                            module,
    ...
    addOutput(createOutput<ZZC_PJ_Port>(Vec(outputsAreaX + stepPeriod * 0, 319.75f),
                                        module,
                                        Phaseque::GATE_OUTPUT));
    addOutput(createOutput<ZZC_PJ_Port>(Vec(outputsAreaX + stepPeriod * 1, 319.75f),
                                        module,
                                        Phaseque::V_OUTPUT));
    addOutput(createOutput<ZZC_PJ_Port>(Vec(outputsAreaX + stepPeriod * 2, 319.75f),
                                        module,
                                        Phaseque::SHIFT_OUTPUT));
    addOutput(createOutput<ZZC_PJ_Port>(Vec(outputsAreaX + stepPeriod * 3, 319.75f),
                                        module,
                                        Phaseque::LEN_OUTPUT));
    addOutput(createOutput<ZZC_PJ_Port>(Vec(outputsAreaX + stepPeriod * 4, 319.75f),
                                        module,
                                        Phaseque::EXPR_OUTPUT));
    addOutput(createOutput<ZZC_PJ_Port>(Vec(outputsAreaX + stepPeriod * 5, 319.75f),
                                        module,
                                        Phaseque::EXPR_CURVE_OUTPUT));
    addOutput(createOutput<ZZC_PJ_Port>(Vec(outputsAreaX + stepPeriod * 6, 319.75f),
                                        module,
                                        Phaseque::PHASE_OUTPUT));

    float outputLedsAreaX = 344.3f;

    addChild(createLight<SmallLight<GreenLight>>(Vec(outputLedsAreaX + stepPeriod * 0, 301.5f),
                                                 module,
                                                 Phaseque::GATE_LIGHT));
    addChild(createLight<SmallLight<GreenRedLight>>(Vec(outputLedsAreaX + stepPeriod * 1, 301.5f),
                                                    module,
                                                    Phaseque::V_POS_LIGHT));
    addChild(createLight<SmallLight<GreenRedLight>>(Vec(outputLedsAreaX + stepPeriod * 2, 301.5f),
                                                    module,
                                                    Phaseque::SHIFT_POS_LIGHT));
    addChild(createLight<SmallLight<GreenRedLight>>(Vec(outputLedsAreaX + stepPeriod * 3, 301.5f),
                                                    module,
                                                    Phaseque::LEN_POS_LIGHT));
    addChild(createLight<SmallLight<GreenRedLight>>(Vec(outputLedsAreaX + stepPeriod * 4, 301.5f),
                                                    module,
                                                    Phaseque::EXPR_POS_LIGHT));
    addChild(createLight<SmallLight<GreenRedLight>>(Vec(outputLedsAreaX + stepPeriod * 5, 301.5f),
                                                    module,
                                                    Phaseque::EXPR_CURVE_POS_LIGHT));
    addChild(createLight<SmallLight<GreenLight>>(Vec(outputLedsAreaX + stepPeriod * 6, 301.5f),
                                                 module,
    ...
    addChild(createWidget<ZZC_Screw>(
...
void PhasequeWidget::appendContextMenu(Menu *menu)
{
    ...
    PhasequeCopyToNextItem *phaseqCopyToNextItem
        = createMenuItem<PhasequeCopyToNextItem>("Copy Steps To Next Pattern");
    PhasequeCopyToPrevItem *phaseqCopyToPrevItem
        = createMenuItem<PhasequeCopyToPrevItem>("Copy Steps To Prev Pattern");
    PhasequeCopyResoItem *phaseqCopyResoItem
        = createMenuItem<PhasequeCopyResoItem>("Copy Reso To All Patterns");
    PhasequeRndAllItem *phaseqRndAllItem
        = createMenuItem<PhasequeRndAllItem>("Randomize All Patterns");
    PhasequeRndAllResoItem *phaseqRndAllResoItem
        = createMenuItem<PhasequeRndAllResoItem>("Randomize All Resolutions");
    PhasequeBakeMutationItem *phaseqBakeMutationItem
        = createMenuItem<PhasequeBakeMutationItem>("Bake Mutation");
    PhasequeClearPatternItem *phaseqClearPatternItem
        = createMenuItem<PhasequeClearPatternItem>("Clear Pattern");
