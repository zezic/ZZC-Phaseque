...
std::vector<std::string> StepAttrNames = {"value",
                                          "length",
                                          "shift",
                                          "expression in",
                                          "expression curve",
...
struct ZZC_PhasequeStepAttrKnob23 : ZZC_PhasequeAttrKnob {
    ...
    {
        setSvg(APP->window->loadSvg(
            asset::plugin(pluginInstance, "res/knobs/ZZC-Knob-27-23-Encoder.svg")));
        shadow->box.size   = Vec(33, 33);
...
struct ZZC_PhasequeStepAttrKnob21 : ZZC_PhasequeAttrKnob {
    ...
    {
        setSvg(APP->window->loadSvg(
            asset::plugin(pluginInstance, "res/knobs/ZZC-Knob-27-21-Encoder.svg")));
        shadow->box.size   = Vec(29, 29);
...
struct ZZC_PhasequeStepAttrKnob21Uni : ZZC_PhasequeStepAttrKnob21 {
    ZZC_PhasequeStepAttrKnob21Uni() { unipolar = true; }
};
...
struct ZZC_PhasequeStepAttrKnob19 : ZZC_PhasequeAttrKnob {
    ...
    {
        setSvg(APP->window->loadSvg(
            asset::plugin(pluginInstance, "res/knobs/ZZC-Knob-27-19-Encoder.svg")));
